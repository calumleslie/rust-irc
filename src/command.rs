...
pub mod commands {
    ...
    commands!(
        ADMIN, AWAY, CONNECT, DIE, ERROR,
        INFO, INVITE, ISON, JOIN, KICK,
        KILL, LINKS, LIST, LUSERS, MODE,
        MOTD, NAMES, NICK, NOTICE, OPER,
        PART, PASS, PING, PONG, PRIVMSG,
        QUIT, REHASH, RESTART, SERVICE, SERVLIST,
        SQUERY, SQUIT, STATS, SUMMON, TIME,
        TOPIC, TRACE, USER, USERHOST, USERS,
